...
public class FishtankPlayerInput extends PlayerInput {
    ...
    public FishtankPlayerInput moveX(float moveX) {
        this.moveX = moveX;
        return this;
    }
    ...
    public FishtankPlayerInput moveY(float moveY) {
        this.moveY = moveY;
        return this;
    }
    ...
    public FishtankPlayerInput rotateX(float rotateX) {
    ...
    public FishtankPlayerInput rotateY(float rotateY) {
    ...
    public FishtankPlayerInput leftTrigger(float leftTrigger) {
    ...
    public FishtankPlayerInput rightTrigger(float leftTrigger) {
        this.leftTrigger = sanitiseTrigger(leftTrigger);
        return this;
    }
    ...
    public FishtankPlayerInput circle(boolean circle) { this.circle = circle; return this; }

    public boolean cross() { return cross; }
    public FishtankPlayerInput cross(boolean cross) { this.cross = cross; return this; }

    public boolean square() { return square; }
    public FishtankPlayerInput square(boolean square) { this.square = square; return this; }

    public boolean triangle() { return triangle; }
    public FishtankPlayerInput triangle(boolean triangle) { this.triangle = triangle; return this; }

    public boolean home() { return home; }
    public FishtankPlayerInput home(boolean home) { this.home = home; return this; }

    public boolean share() { return share; }
    public FishtankPlayerInput share(boolean share) { this.share = share; return this; }

    public boolean options() { return options; }
    public FishtankPlayerInput options(boolean options) { this.options = options; return this; }

    public boolean trackpad() { return trackpad; }
    public FishtankPlayerInput trackpad(boolean trackpad) { this.trackpad = trackpad; return this; }

    public boolean hatUp() { return hatUp; }
    public FishtankPlayerInput hatUp(boolean hatUp) { this.hatUp = hatUp; return this; }

    public boolean hatDown() { return hatDown; }
    public FishtankPlayerInput hatDown(boolean hatDown) { this.hatDown = hatDown; return this; }

    public boolean hatLeft() { return hatLeft; }
    public FishtankPlayerInput hatLeft(boolean hatLeft) { this.hatLeft = hatLeft; return this; }

    public boolean hatRight() { return hatRight; }
    public FishtankPlayerInput hatRight(boolean hatRight) { this.hatRight = hatRight; return this; }

    public float getDesiredForwardSpeed() {
        return desiredForwardSpeed;
    }

    public FishtankPlayerInput setDesiredForwardSpeed(float desiredForwardSpeed) {
    ...
    public FishtankPlayerInput setDesiredRotationSpeed(float desiredRotationSpeed) {
