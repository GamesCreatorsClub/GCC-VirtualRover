...
public class BenchyObject extends GameObjectWithPositionAndOrientation {

    public static BoundingBox BOUNDING_BOX = new BoundingBox(
            new Vector3(-2.3f, -12.8f, -8.2f),
            new Vector3(2.3f, 12.7f, 7.7f));

    public BenchyObject(GameObjectFactory factory, int id) {
        super(factory, id);
    }
    ...
    @Override
    public GameObjectType getType() { return FishtankGameTypeObject.Benchy; }
}
