...
public class PiWarsHtmlPlatformSpecific extends AbstractPlatformSpecific {

    private PiWarsHtmlServerCommunication htmlServerCommunication;

    public PiWarsHtmlPlatformSpecific() {
        htmlServerCommunication = new PiWarsHtmlServerCommunication();
    }
