...
import org.ah.piwars.virtualrover.challenges.MineSweeperArena;
...
public class MineSweeperScreen extends AbstractStandardScreen implements ChallengeScreen {
    ...
    public MineSweeperScreen(MainGame game,
        ...
        MineSweeperArena challenge = new MineSweeperArena(modelFactory, serverCommunicationAdapter);
        challenge.init();
